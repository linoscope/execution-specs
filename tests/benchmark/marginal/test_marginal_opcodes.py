...
JUMP_CONFIG = CustomTargetConfig(
    name="JUMP", max_op_count=200, step=50, num_calls=6250  # 4 points
)
JUMPI_CONFIG = CustomTargetConfig(
    name="JUMPI", max_op_count=200, step=50, num_calls=3200  # 4 points
)
